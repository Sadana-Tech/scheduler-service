...
import org.gov.in.service.JobSchedulingServiceImpl;
...
public class JobSchedulingController {
  ...
  private JobSchedulingServiceImpl jobSchedulingServiceImpl;
  ...
  public ResponseEntity<Response> scheduleATask(@RequestBody JobDetails jobDetails) {
    ...
    return new ResponseEntity<>(
        jobSchedulingServiceImpl.scheduleATask(jobDetails, taskDefinitionBean),
        HttpStatus.ACCEPTED);
  }
  ...
  public ResponseEntity<Response> removeJob(@RequestBody JobDetails jobDetails) {
    return new ResponseEntity<>(jobSchedulingServiceImpl.removeScheduledTask(jobDetails),
        HttpStatus.ACCEPTED);
